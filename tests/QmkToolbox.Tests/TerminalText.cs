...
{
    /// <summary>
    /// The buffer's raw text: segments concatenated, lines joined with '\n', no prefixes.
    /// Prefixes and rendering belong to TerminalProjection; buffer-level tests assert content only.
    /// </summary>
