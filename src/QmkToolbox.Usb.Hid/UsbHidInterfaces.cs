...
/// <summary>
/// Enumerates the HID interfaces of connected devices, such as a keyboard's console
/// interface, and opens them for report I/O.
/// </summary>
public static class UsbHidInterfaces
{
    // hid_exit is optional; hidapi stays initialised for the process lifetime.
    ...
    /// interfaces (regular keyboards, mice) appear too; opening them fails.
    /// </summary>
    ...
    /// <summary>
    /// Opens the interface described by <paramref name="iface"/> for report I/O. Returns null
    /// when the interface has disappeared since enumeration or refuses to open.
    /// </summary>
