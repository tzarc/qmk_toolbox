...
/// <summary>
/// One top-level collection of a HID interface on a connected device: the USB identity, the
/// collection's usage pair, and the platform path that opens the interface. An interface with
/// several top-level collections yields one entry per collection.
/// </summary>
