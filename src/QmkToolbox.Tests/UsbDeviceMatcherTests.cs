...
public class UsbDeviceMatcherTests
{
    ...
    public void Find_PathTakesPrecedenceOverVidPid()
    {
        ...
        IReadOnlyList<IUsbDevice> tracked = [Dev("/other", 9, 9), pathHit];
    ...
    public void Find_NoPathMatch_FallsBackToVidPid()
    {
        ...
        IReadOnlyList<IUsbDevice> tracked = [Dev("/a", 1, 2), b];
    ...
    public void Find_EmptyEventPath_UsesVidPidFallback()
    {
        ...
        IReadOnlyList<IUsbDevice> tracked = [a];
    ...
    {
        IReadOnlyList<IUsbDevice> tracked = [Dev("/a", 1, 2)];
    ...
    {
        IReadOnlyList<IUsbDevice> tracked = [Dev("", 1, 2)];
    ...
    {
        IReadOnlyList<IUsbDevice> tracked = [Dev(@"\\?\USB#VID_1", 1, 2)];
    ...
    public void Find_MultipleVidPidCandidates_ReturnsFirst()
    {
        ...
        IReadOnlyList<IUsbDevice> tracked = [first, Dev("/b", 5, 6)];
