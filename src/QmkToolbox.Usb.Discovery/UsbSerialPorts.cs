...
using QmkToolbox.Usb.Discovery.MacOS;
...
public static class UsbSerialPorts
{
    ...
    /// primary interface first; a device with none yields nothing.
    /// </summary>
    ...
    public static IEnumerable<string> EnumerateSerialPorts(this UsbDeviceInfo device) =>
        ...
        OperatingSystem.IsWindows() ? Windows.WindowsSerialPorts.EnumerateComPorts(device) :
        [];
