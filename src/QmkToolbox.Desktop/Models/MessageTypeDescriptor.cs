...
/// per-theme colours. Colours are plain <see cref="Color"/> structs rather than brushes, so model
/// code such as <see cref="TerminalProjection"/> can read this table without pulling in view
/// types; <c>MessageTypeStyles</c> derives cached brushes from it.
/// </summary>
